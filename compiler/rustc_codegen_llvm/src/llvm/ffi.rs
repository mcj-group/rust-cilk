...
unsafe extern "C" {
    ...
    pub(crate) fn LLVMRustMDGetTemporary(C: &Context) -> &mut Metadata;
    pub(crate) fn LLVMRustMDDeleteTemporary(Metadata: &mut Metadata);
    ...
    pub(crate) fn LLVMRustReplaceMDOperandWith<'a>(
        Metadata: &'a Metadata,
        Index: size_t,
