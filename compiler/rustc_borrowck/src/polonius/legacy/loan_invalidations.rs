...
impl<'a, 'tcx> Visitor<'tcx> for LoanInvalidationsGenerator<'a, 'tcx> {
    fn visit_statement(&mut self, statement: &Statement<'tcx>, location: Location) {
        ...
        match &statement.kind {
            ...
            StatementKind::Intrinsic(box NonDivergingIntrinsic::TapirRuntimeStart) | StatementKind::Intrinsic(box NonDivergingIntrinsic::TapirRuntimeStop) | StatementKind::Intrinsic(box NonDivergingIntrinsic::TaskframeCreate(_)) | StatementKind::Intrinsic(box NonDivergingIntrinsic::TaskframeUse(_)) | StatementKind::Intrinsic(box NonDivergingIntrinsic::TaskframeEnd(_)) | StatementKind::Intrinsic(box NonDivergingIntrinsic::TapirSyncRegionStart(_)) | StatementKind::Intrinsic(box NonDivergingIntrinsic::OrphaningSyncregion(_)) => {}
