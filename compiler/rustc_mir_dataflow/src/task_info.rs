...
impl<'body, 'tcx> TaskInfoBuilder<'body, 'tcx> {
    ...
    fn despeculate_phi_spindles(&mut self) -> DenseBitSet<Spindle> {
        ...
        let mut removed_spindles = DenseBitSet::new_empty(self.spindles.len());
    ...
    fn remove_empty_spindles(&mut self, removed_spindles: &DenseBitSet<Spindle>) -> &mut Self {
